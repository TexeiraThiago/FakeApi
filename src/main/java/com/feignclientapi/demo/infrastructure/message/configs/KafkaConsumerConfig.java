package com.feignclientapi.demo.infrastructure.message.configs;
...
public class KafkaConsumerConfig {
    ...
    @Value("${topic.fake-api.consumer.group-id}")
    ...
    public ConsumerFactory<String, ProductDTO> consumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(), new
                JsonDeserializer<>(ProductDTO.class));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, ProductDTO>
    kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, ProductDTO> factory = new
